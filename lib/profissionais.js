...
export function sortServicos(prof) {
  if (!prof) return prof;
  return {
    ...prof,
...
// Busca todos os profissionais, mais recentes primeiro. Usado pelo catálogo SSR.
...
// Busca todas as avaliações. Usado em conjunto com getAllProfissionais no catálogo.
