...
// Tipos de evento de indicação (compartilhamento de perfil). Ver lib/eventos.js.
const ehShare = (tipo) => tipo === "share_perfil" || tipo === "share_pos_avaliacao";
...
export function computeAnalyticsEventos(eventos = [], { dias = 30, agora = new Date() } = {}) {
  ...
  let shares = 0;
  const sharesPorTipo = { share_perfil: 0, share_pos_avaliacao: 0 };
