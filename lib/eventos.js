...
//     | share_perfil        — indicação do perfil (perfil ou pós-avaliação)
//                             `canal`: nativo | whatsapp | link_copiado
//                             | instagram | status | facebook | perfil (canais UTM do painel)
//     | share_pos_avaliacao — indicação feita depois de avaliar
