          ...
          >
            ...
            {status === "success" ? (
              <div style={{ textAlign: "center", padding: "32px 0" }}>
                ...
                <p style={{ fontFamily: "var(--display)", fontSize: 18 }}>
              ...
              <>
                  ...
                  {tipos.map((t) => (
                    <button
                      ...
                      style={{
                        ...
                        border:
                          "1.5px solid " + (tipo === t.value ? "var(--red)" : "var(--border)"),
                        borderRadius: 10,
                        padding: "14px 8px",
                        textAlign: "center",
                        cursor: "pointer",
                    ...
                    >
                      ...
                      <div
                        style={{
                          fontSize: 12,
                          fontWeight: 700,
                          color: tipo === t.value ? "var(--red)" : "var(--black)",
                        }}
                      >
                        {t.label}
                      </div>
                      <div style={{ fontSize: 10, color: "var(--grey-light)", marginTop: 2 }}>
                        {t.desc}
                      </div>
                    </button>
                  ))}
                ...
                <button
                  ...
                  style={{
                    width: "100%",
                    background: valid ? "var(--black)" : "var(--border)",
                    color: "#fff",
                    border: "none",
                    borderRadius: 8,
                    padding: "14px",
